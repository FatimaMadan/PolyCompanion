...
class UploadDescr {
    ...
    function __construct() {
        ...
        $this->allowed_mime_types = array('text/plain', 'text/html', 'image/jpeg', 'image/png', 'image/gif', 'image/tiff', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/vnd.ms-excel',  'application/zip',  'application/vnd.ms-project');
    ...
    public function upload($object) {
      ...
      if (empty($error)) {
        ...
        elseif ($files['size'] >= $this->max_file_size)
            ...
            $allowedExtensions = ['txt', 'html', 'jpeg', 'jpg', 'png', 'gif', 'tiff', 'doc', 'docx', 'xlsx', 'xls', 'zip', 'mpp'];
